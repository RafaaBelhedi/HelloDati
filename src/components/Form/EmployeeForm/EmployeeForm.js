...
import AutorisationsList from './AutorisationsList/AutorisationsList'
...
class EmployeeForm extends Component {
	...
	async submit() {
		...
		} else if (document.forms["formAddEmployee"]["name"].value == "") {
			await this.setState({ alert_message: [...this.state.alert_message, "Missing Name Employee!"] })
		}


		if (document.forms["formAddEmployee"]["email"].value) {
		...
		} else if (document.forms["formAddEmployee"]["email"].value == "") {
			await this.setState({ alert_message: [...this.state.alert_message, "Missing Email Employee!"] })
		}

		if (document.forms["formAddEmployee"]["password"].value == "") {
			await this.setState({ alert_message: [...this.state.alert_message, "Missing Password !"] })
		}

		(this.state.data.gender == undefined && await this.setState({ alert_message: [...this.state.alert_message, "Missing gender!"] }))

		if (document.forms["formAddEmployee"]["born"].value) {
			if (!/\d{4}-\d{2}-\d{2}/.test(this.state.data.born)) {
				this.setState({ alert_message: [...this.state.alert_message, "Invalid Born Date format !"] })
			}
		} else if (document.forms["formAddEmployee"]["born"].value == "") {
			await this.setState({ alert_message: [...this.state.alert_message, "Missing Born Date!"] })
		}


		if (document.forms["formAddEmployee"]["phone_number"].value) {
			if (!/^[0-9]*$/.test(this.state.data.phone_number)) {
				this.setState({ alert_message: [...this.state.alert_message, " Invalid Phone number  !"] })
			}
		} else if (document.forms["formAddEmployee"]["phone_number"].value == "") {
			await this.setState({ alert_message: [...this.state.alert_message, "Missing Phone number!"] })
		}

		if (document.forms["formAddEmployee"]["cin"].value) {
			if (!/^[0-9-A-Za-z]*$/.test(this.state.data.cin)) {
				this.setState({ alert_message: [...this.state.alert_message, "Invalid cin!"] })
			}
		} else if (document.forms["formAddEmployee"]["cin"].value == "") {
	...
	render() {
		return <div className='employee-form-add-auto'>
			...
			<div className="employee-inputs-all" >
				...
				<div className="employee-inputs add">
					<form name="formAddEmployee">
						...
						<input placeholder="Name" name="name" onChange={(e) => this.setData({ name: e.target.value })} />
						<input type="text" placeholder="Email" name="email" onChange={(e) => this.setData({ email: e.target.value })} />
						<input type="password" placeholder="Password" name="password" onChange={(e) => this.setData({ password: e.target.value })} />
						...
						<input type="date" placeholder="Born" name="born" onChange={(e) => this.setData({ born: e.target.value })} />
						<input type="text" placeholder="Phone_number" name="phone_number" onChange={(e) => this.setData({ phone_number: e.target.value })} />
						<input type="text" placeholder="Cin" name="cin" onChange={(e) => this.setData({ cin: e.target.value })} />
						<select name="country" name="country" onChange={(e) => this.setData({ country: e.target.value })} >
						...
						<input type="text" placeholder="City" name="city" onChange={(e) => this.setData({ city: e.target.value })} />
						<input type="text" placeholder="Zip code" name="zip_code" onChange={(e) => this.setData({ zip_code: e.target.value })} />
						<input type="text" placeholder=" Adress" name="adress" onChange={(e) => this.setData({ adress: e.target.value })} />
...
EmployeeForm.contextType = UserContext
