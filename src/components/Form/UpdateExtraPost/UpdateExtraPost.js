...
class UpdateExtraPost extends Component {
  ...
  async componentDidMount(){
    let post = await callApi('extra_post/'+this.state.data.id)
    this.setState({data:{...post.data[0]}})
  }
...
UpdateExtraPost.contextType = UserContext

export default UpdateExtraPost;
