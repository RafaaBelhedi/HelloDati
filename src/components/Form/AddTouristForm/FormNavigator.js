...
import "./FormNavigatorTourist.scss"
...
class FormNavigator extends Component {
  ...
  render() {
    return <div className="form-navigator-tourist">
      <FormPage title={this.state.elements[this.state.index].props.title}>{React.cloneElement(this.state.elements[this.state.index], { tourist: this.props.tourist, rooms: this.props.rooms })}</FormPage>
