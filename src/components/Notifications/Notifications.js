...
class Notifications extends Component {
  ...
  async componentDidMount() {
    ...
    console.log(tourists,"touristsgg")
 ...
 async setAgeIntervalle(age) {
  ...
  console.log(tourists.data,"Alltourists")
}
  async sendMen(){
  let Alltourists = await callApi('tourists', { hotel_id: this.context.hotel_id[0] })
  console.log(Alltourists.data,"Alltourists")
  ...
  console.log(touristsMen,"touristsgg bbb")
...
async sendWomen(){
  ...
  console.log(touristsWomen,"touristsgg bbb")
}
  ...
  async notify() {
    var formdata = new FormData();
    formdata.append("data",JSON.stringify({"title": this.state.title, "summery" : this.state.summery,"image": this.state.image,"promo" : this.state.promo}));
    this.state.tourists.map(x=>  { callApiWithBody('notif_hotels_devices?imei= '+x.stay.device_room.device.imei,formdata, 'POST').then(res=>{
 ...
 await callApi('tourists', { hotel_id: this.context.hotel_id[0] }).then(res=>{
    ...
    console.log(res,"length ryetyzefgycsdffyt")
    console.log(touristage.length,"touristage fgycsdffyt")
    
  })
// console.log("ryetyzefgycsdffyt",touristAgeSet)
 
 console.log(minAge,"tattata lbara")
 console.log(maxAge,"tattata lbara")
  ...
  render() {
    ...
    {console.log("this is"+message )})
     ...
     console.log(this.state,"tattatayyy")
